...
public class ModItemGroups {
  public static final ItemGroup ARCANE_ARTISTRY_GROUP = Registry.register(Registries.ITEM_GROUP,
      ArcaneArtistry.newIdentifier("arcane_artistry_group"),
      FabricItemGroup.builder()
          .displayName(Text.translatable("itemgroup.arcane_artistry_group"))
          .icon(() -> new ItemStack(ModItems.ODDLY_SHAPED_STICK))
