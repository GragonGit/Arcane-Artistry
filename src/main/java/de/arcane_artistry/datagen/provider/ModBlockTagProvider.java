...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
  ...
  protected void configure(RegistryWrapper.WrapperLookup arg) {
    // Mod Block Tags
    getOrCreateTagBuilder(ModBlockTags.AZURE_LOGS)
        .add(ModBlocks.AZURE_LOG)
        .add(ModBlocks.AZURE_WOOD)
        .add(ModBlocks.STRIPPED_AZURE_LOG)
        .add(ModBlocks.STRIPPED_AZURE_WOOD);
    getOrCreateTagBuilder(ModBlockTags.AZURE_LEAVES)
        .add(ModBlocks.AZURE_LEAVES)
        .add(ModBlocks.SHIMMERING_AZURE_LEAVES);

    // Vanilla Block Tags
    getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE)
        .add(ModBlocks.STONE_LAPIS_CRYSTAL).add(ModBlocks.DEEPSLATE_LAPIS_CRYSTAL);
