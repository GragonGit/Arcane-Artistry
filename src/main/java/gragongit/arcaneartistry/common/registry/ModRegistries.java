...
public final class ModRegistries {
  ...
  public static final ResourceKey<Registry<Staff>> STAFF_KEY = ResourceKey.createRegistryKey(ArcaneArtistry.id("staff"));

  public static void register() {
    ArcaneArtistry.LOGGER.info("Registering dynamic registries");
    DynamicRegistries.registerSynced(STAFF_KEY, Staff.CODEC);
  }
}
