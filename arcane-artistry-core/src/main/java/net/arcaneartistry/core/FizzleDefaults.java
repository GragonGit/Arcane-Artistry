 ...
 *
 * <p>
 * This is a plain opt-out, not a cancellable event: v1 doesn't need
 ...
 *
 * <p>
 * {@link #playAt} is public so other modules can reuse the exact same cue
...
public final class FizzleDefaults {
  ...
  public static void playAt(ServerLevel world, Vec3 position) {
