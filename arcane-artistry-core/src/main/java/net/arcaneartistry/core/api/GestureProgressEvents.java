 ...
 *
 * <p>
 * This directly answers design document open question 3 ("is it possible
...
public final class GestureProgressEvents {
  ...
  public interface Started {
    void onGestureStarted(LocalPlayer player, ItemStack stack);
  }

  public interface StrokeAdded {
    void onGestureStrokeAdded(LocalPlayer player, List<GestureDirection> strokesSoFar);
  }

  public interface Ended {
    void onGestureEnded(LocalPlayer player, List<GestureDirection> finalStrokes);
  }
