 ...
 *
 * <p>
 * Core has zero opinion on what that identifier <em>means</em> -- it might
 ...
 *
 * <p>
 * The registry is expected to stay small (dozens of patterns, not
...
public final class GesturePatternRegistry {
  ...
  /**
   * Removes {@code id}'s pattern, if any. Safe to call even if it was never
   * registered.
   */
  ...
  /**
   * Convenience for reload listeners replacing a whole previously-owned batch at
   * once.
   */
